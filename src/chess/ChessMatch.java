...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPodition) {
		Position source = sourcePosition.toPosition();
		Position target = targetPodition.toPosition();
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if (!type.equals("B") && !type.equals("H") && !type.equals("K") && !type.equals("Q") && !type.equals("R")) {
			return promoted;
		}
	...
	private void validateTargetPosition(Position soource, Position target) {
